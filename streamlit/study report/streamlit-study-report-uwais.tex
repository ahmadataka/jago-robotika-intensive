...
\begin{center}
\includegraphics[width=0.22\textwidth]{jago-robotika-logo-final.png}\\[0.8em]
{\LARGE \textbf{Study Report Jago Robotika}}\\[1em]
\end{center}

\begin{tabular}{@{}ll@{}}
\textbf{Kelas} & : Streamlit Python \\
\textbf{Nama Siswa} & : Uwais Ruzali Rustam Aziz \\
...
\textbf{Link Streamlit App} & : \url{https://uwais-learning.streamlit.app} \\
\end{tabular}

\begin{center}
\includegraphics[width=0.82\textwidth]{app-preview-uwais.jpg}\\
\small \textit{Preview tampilan salah satu aplikasi Streamlit siswa.}
\end{center}
...
\begin{itemize}
\item [--] Uwais mengikuti kelas dengan antusias dan menunjukkan minat yang baik terhadap pembuatan aplikasi web. Uwais juga aktif mencoba fitur-fitur baru saat praktik dan mampu mengikuti arahan tutor dengan baik.
\item [--] Uwais mampu menerapkan materi yang dipelajari ke dalam proyek personal website yang rapi dan komunikatif. Ia dapat menggabungkan navigasi, konten profil, galeri, dan elemen interaktif menjadi satu aplikasi yang utuh.
\item [--] Yang bisa terus ditingkatkan adalah kecepatan dan kerapian saat menulis kode, terutama ketika menyusun struktur aplikasi yang lebih panjang. Dengan lebih banyak latihan, Uwais akan semakin lancar menuangkan ide menjadi program yang siap dipublikasikan.
\end{itemize}
