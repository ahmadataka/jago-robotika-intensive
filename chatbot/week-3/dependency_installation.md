# Persiapan Komputer - Chatbot Week 3
...
3. Buat folder baru, misalnya `chatbot-week-3`, di lokasi yang mudah ditemukan.
4. Buka VS Code, lalu pilih **File > Open Folder** dan pilih folder `chatbot-week-3`.
