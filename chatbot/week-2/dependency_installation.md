# Persiapan Komputer - Chatbot Week 2
...
3. Buat folder baru, misalnya `chatbot-week-2`, di lokasi yang mudah ditemukan.
4. Buka VS Code, lalu pilih **File > Open Folder** dan pilih folder `chatbot-week-2`.
