# Persiapan Komputer - Computer Vision Week 3
...
3. Buat folder baru, misalnya `computer-vision-week-3`, di lokasi yang mudah ditemukan.
4. Buka VS Code, lalu pilih **File > Open Folder** dan pilih folder `computer-vision-week-3`.
